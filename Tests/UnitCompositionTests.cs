...
namespace Tests
{
	public class UnitCompositionTests
	{
		...
		public void TestGetUnitCompositions()
		{
			...
			// InfestedTerran, 1195 - 120(40*3 spawns), 470(spines), 80(evo chamber), 525(abberation)
			...
			var actual = UnitCompositionGenerator.GetComposition(difficulty).ToList();
