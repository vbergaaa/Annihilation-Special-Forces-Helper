...
namespace Tests
{
	...
	public class WeaponsTest
	{
		...
		[TestCase(UnitType.CrimsonArchon, 184061)]
		[TestCase(UnitType.DarkArchon, 50672)]
		...
		[TestCase(UnitType.TerminatorWarpLord, 44084)]
		[TestCase(UnitType.UnstableDreadnought, 5938)]
		[TestCase(UnitType.WarpLord, 5745)]
		[TestCase(UnitType.WingedArchon, 423899)]
