...
namespace VBusiness.Units
{
	public class Unit : VUnit
	{
		...
		public override double Attack => UnitData.GetWeapons(Loadout).First().BaseAttack + Upgrades.AttackUpgrade * UnitData.GetWeapons(Loadout).First().AttackIncrement;
		public override double AttackSpeed => UnitData.GetWeapons(Loadout).First().BaseAttackPeriod * Math.Pow(0.96, Upgrades.AttackSpeedUpgrade);
