...
namespace VUserInterface
{
	partial class ProfileControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.ProfileTitleLabel.Location = DPIScalingHelper.GetScaledPoint(120, 10);
			...
			this.NameTextBox.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.PerkPointsLabel2.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.RankPointsTextBox.MaximumSize = DPIScalingHelper.GetScaledSize(500, 22);
			...
			this.ModScoreTextBox.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.GemsTextBox.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.CPTextBox.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.NameLabel.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.RankLabel.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.PerkPointsLabel.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.RankPointsLabel.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.ModScoreLabel.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.GemsLabel.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.CPLabel.MaximumSize = DPIScalingHelper.GetScaledSize(500, 24);
			...
			this.EditPanel.Location = DPIScalingHelper.GetScaledPoint(0, 40);
			...
			this.ReadonlyPanel.Location = DPIScalingHelper.GetScaledPoint(0, 40);
			...
			// SaveEditButton
			// 
			this.SaveEditButton.Location = DPIScalingHelper.GetScaledPoint(275, 12);
			...
			// AchievementsButton
			// 
			this.AchievementsButton.Location = DPIScalingHelper.GetScaledPoint(250, 215);
			this.AchievementsButton.Name = "AchievementsButton";
			this.AchievementsButton.Size = DPIScalingHelper.GetScaledSize(100, 23);
			this.AchievementsButton.TabIndex = 0;
			...
			this.AchievementsLabel.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.BindingSource, "AchievementCount", true));
			this.AchievementsLabel.Location = DPIScalingHelper.GetScaledPoint(150, 215);
			this.AchievementsLabel.Name = "AchievementsLabel";
			this.AchievementsLabel.Size = DPIScalingHelper.GetScaledSize(100, 23);
			this.AchievementsLabel.TabIndex = 0;
			// 
			// ProfileControl
			// 
